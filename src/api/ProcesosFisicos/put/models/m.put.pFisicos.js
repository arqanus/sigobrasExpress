...
module.exports = {
    ...
    putCategoriaPrioridad({ id_iconoCategoria, id_prioridad, id_partida }) {
        return new Promise((resolve, reject) => {
            pool.query("UPDATE partidas SET iconosCategorias_id_iconoCategoria = ?, prioridades_id_prioridad = ? WHERE (id_partida = ?);", [id_iconoCategoria, id_prioridad, id_partida], (error, res) => {
                if (error) {
                    reject(error);
                }
                resolve(res)
