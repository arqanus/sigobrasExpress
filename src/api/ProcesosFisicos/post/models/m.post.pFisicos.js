...
userModel.getActividadesbyIdActividad = (id_partida,callback)=>{
    console.log("getActividadesbyIdActividad");
    pool.getConnection(function(err ,conn){
        if(err){ callback(err);}
        else{
