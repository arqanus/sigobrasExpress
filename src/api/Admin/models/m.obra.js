...
module.exports = {
    putFichas({ id_ficha,fecha_inicial, g_sector,g_pliego,g_func,g_prog,g_subprog,g_tipo_act,g_tipo_comp,g_meta,g_snip,g_local_dist,g_local_prov,g_local_reg,f_fuente_finan,f_entidad_finan,f_entidad_ejec,tiempo_ejec,g_total_presu,lugar,modalidad_ejecutora,confirmacion_super_inf,codigo_unificado,centropoblado_direccion}) 
    // putFichas(data)
        {
        ...
        return new Promise((resolve, reject) => {
            ...
            SET 
                ...
                confirmacion_super_inf = \'${confirmacion_super_inf} \',
