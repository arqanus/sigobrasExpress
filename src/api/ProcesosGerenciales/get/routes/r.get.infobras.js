...
module.exports = (app) => {
    ...
    app.post('/infobras', async (peticion, respuesta) => {
        try {
            ...
            var req_costoDirecto = await User.presupuestoCostoDirecto(peticion.body.id_ficha)
            ...
            data[0].porcentaje_acumulado = Format.formatoSoles(data[0].porcentaje_acumulado)
