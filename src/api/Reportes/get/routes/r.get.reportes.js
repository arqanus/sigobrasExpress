...
module.exports = function (app) {
  ...
  app.post('/getInformeDataGeneral', async (req, res) => {
    try {
      ...
      InformeDataGeneral.porcentaje_avance_fisico = res_avanceActual.valor / res_costodirecto.presupuesto * 100
      InformeDataGeneral.porcentaje_avance_acumulado = res_avanceTotal.valor / res_costodirecto.presupuesto * 100
