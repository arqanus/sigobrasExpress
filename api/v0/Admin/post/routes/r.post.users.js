...
module.exports = function (app) {
  app.post("/nuevoUsuario", async (req, res) => {
    try {
      ...
      // res.json(formFiles)
      if (
        formFiles.fields.imagen == "null" ||
        formFiles.fields.imagen == "undefined"
      ) {
      ...
      if (formFiles.files.imagen) {
        ...
        var id_usuario = await User.putUsuarioImagen(
  ...
  app.post("/nuevoAcceso", async (req, res) => {
    try {
      req.body.menu =
        '[{"ruta":"","submenus":[{"ruta":"/MDHistorial","nombreMenu":"Historial de metrados","nombrecomponente":"MDHistorial"},{"ruta":"/General","nombreMenu":"Valorizaciones","nombrecomponente":"General"},{"ruta":"/RecursosObra","nombreMenu":"Recursos","nombrecomponente":"RecursosObra"},{"ruta":"/HistorialImagenesObra","nombreMenu":"Historial de imágenes","nombrecomponente":"HistorialImagenesObra"}],"nombreMenu":"PROCESOS FISICOS"},{"ruta":"","submenus":[{"ruta":"/Analitico","nombreMenu":"Analitico","nombrecomponente":"Analitico"},{"ruta":"/Otros","nombreMenu":"Otos","nombrecomponente":"Otros"}],"nombreMenu":"PROCESOS GERENCIALES"}]';
