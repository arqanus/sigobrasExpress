...
//imagenes
userModel.AnyoInicial = (id_ficha) => {
  //nombra la query
  return new Promise((resolve, reject) => {
    var query =
      "select year(fecha_inicial) anyo_inicial from fichas where id_ficha = ?;"; //AHI SE CAMBIA LA QUERY
...
userModel.ComponentesProyeccion = (id_ficha) => {
  //nombra la query
  return new Promise((resolve, reject) => {
    var query =
      " select componentes.* FROM componentes where fichas_id_ficha = ?"; //AHI SE CAMBIA LA QUERY
    pool.query(query, [id_ficha], (error, resultado) => {
      //ejecutqa la query
      if (error) {
        reject(error); //reconoce el error
...
userModel.ComponentesProyeccionAvance = (id_ficha, anyo, mes) => {
  //nombra la query
  return new Promise((resolve, reject) => {
    var query =
    ...
    pool.query(query, [anyo, mes, id_ficha], (error, resultado) => {
      //ejecutqa la query
      if (error) {
        reject(error); //reconoce el error
      } else {
...
userModel.postProyeccion = (proyeccion_exptec, mes_anyo, id_componente) => {
  return new Promise((resolve, reject) => {
    var querytext =
      "INSERT INTO avance_proyecciones (proyeccion_exptec, mes_anyo, componentes_id_componente) VALUES (?, ?, ?)"; //AHI SE CAMBIA LA QUERY
    pool.query(
      querytext,
      [proyeccion_exptec, mes_anyo, id_componente],
      (error, resultado) => {
        if (error) {
          reject(error);
        } else {
...
userModel.verificarMesAnyoComponente = (mes_anyo, id_componente) => {
  //nombra la query
  return new Promise((resolve, reject) => {
    var querytext =
      "select * from avance_proyecciones where mes_anyo = ? and componentes_id_componente = ?;";
    pool.query(querytext, [mes_anyo, id_componente], (error, resultado) => {
      //ejecutqa la query
      if (error) {
        reject(error); //reconoce el error
      } else {
...
userModel.postProyeccionActualizar = (
  proyeccion_exptec,
  mes_anyo,
  id_componente
) => {
  return new Promise((resolve, reject) => {
    var querytext =
      "UPDATE avance_proyecciones SET proyeccion_exptec = ? WHERE mes_anyo = ? and componentes_id_componente = ?;";
    pool.query(
      querytext,
      [proyeccion_exptec, mes_anyo, id_componente],
      (error, resultado) => {
...
userModel.postProyeccionVar = (
  ...
  return new Promise((resolve, reject) => {
    var querytext =
      "INSERT INTO avance_proyecciones (proyeccion_variable, mes_anyo, componentes_id_componente) VALUES (?, ?, ?)"; //AHI SE CAMBIA LA QUERY
    pool.query(
      querytext,
      [proyeccion_variable, mes_anyo, id_componente],
      (error, resultado) => {
        if (error) {
          reject(error);
        } else {
...
userModel.postProyeccionVarActualizar = (
  proyeccion_exptec,
  mes_anyo,
  id_componente
) => {
  return new Promise((resolve, reject) => {
    var querytext =
      "UPDATE avance_proyecciones SET proyeccion_variable = ? WHERE mes_anyo = ? and componentes_id_componente = ?;";
    pool.query(
      querytext,
      [proyeccion_exptec, mes_anyo, id_componente],
      (error, resultado) => {
...
userModel.verificarMesAnyoComponenteVar = (mes_anyo, id_componente) => {
  //nombra la query
  return new Promise((resolve, reject) => {
    var querytext =
      "select * from avance_proyecciones where mes_anyo = ? and componentes_id_componente = ?;";
...
userModel.chart_avance = (id_ficha, anyo, id_componente) => {
  //nombra la query
  return new Promise((resolve, reject) => {
    var querytext =
...
userModel.putproyecciones = (insertintoproeccion) => {
  //nombra la query
  return new Promise((resolve, reject) => {
    var query =
      "INSERT INTO avance_proyecciones (proyeccion_exptec, proyeccion_variable, mes_anyo, componentes_id_componente) VALUES ? ON DUPLICATE KEY UPDATE proyeccion_exptec = values(proyeccion_exptec), proyeccion_variable = values(proyeccion_variable)"; //AHI SE CAMBIA LA QUERY
    pool.query(query, [insertintoproeccion], (error, resultado) => {
      //ejecutqa la query
      if (error) {
        reject(error); //reconoce el error
      } else {
